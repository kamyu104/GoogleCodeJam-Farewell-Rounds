...
![Progress](https://img.shields.io/badge/progress-17%20%2F%2020-ff69b4.svg)
...
|B| [Genetic Sequences](https://codingcompetitions.withgoogle.com/codejam/round/0000000000c95b95/0000000000cadc77)| [PyPy3](./Round%20D/genetic_sequences.py3) | _O((N + M) * log(N + M) + Q * logM * logN)_ | _O((N + M) * log(N + M))_ | Medium | | Suffix Array, LCP Array, Binary Search, RMQ, Sparse Table, Persistent BST, Treap |
